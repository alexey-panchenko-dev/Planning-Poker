  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className={`flex items-center gap-3 px-4 py-2 border rounded-xl transition-all duration-200 cursor-pointer
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-card-bg border border-font-muted/20 rounded-xl shadow-2xl py-2 z-50 animate-in fade-in zoom-in duration-150">
